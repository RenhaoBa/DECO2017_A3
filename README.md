...
#### Changed selection modes for "Due Time" and "Estumated Time of Finish". Change the original input type to select type, increasing affordance.
![image](mockup2.jpg)
![image](mockup3.png)

#### Added pause function for timer.
![image](mockup_timer.jpg)
![image](mockup_timer1.png)